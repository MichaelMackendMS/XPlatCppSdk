...
namespace PlayFab
{
    ...
    PlayFabAndroidHttpPlugin::RequestTask::~RequestTask() = default;
...
namespace PlayFab
{
    ...
    void PlayFabAndroidHttpPlugin::SetPredefinedHeaders(RequestTask& requestTask) const
    {
    ...
    void PlayFabAndroidHttpPlugin::SetHeader(RequestTask& requestTask, const char* name, const char* value) const
    {
        CallRequestContainer& requestContainer = requestTask.RequestContainer();
    ...
    void PlayFabAndroidHttpPlugin::ProcessResponse(RequestTask& requestTask, const int httpCode) const
    {
        CallRequestContainer& requestContainer = requestTask.RequestContainer();
