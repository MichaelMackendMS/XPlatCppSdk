...
namespace PlayFab
{
    ...
    void OneDSAndroidHttpPlugin::SetPredefinedHeaders(RequestTask& requestTask) const
    {
    ...
    void OneDSAndroidHttpPlugin::ProcessResponse(RequestTask& requestTask, const int httpCode) const
    {
        OneDSCallRequestContainer& requestContainer = requestTask.OneDSRequestContainer();
