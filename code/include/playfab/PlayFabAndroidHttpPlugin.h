...
namespace PlayFab
{
    ...
    protected:
        ...
        virtual void SetPredefinedHeaders(RequestTask& requestTask) const;
        virtual void SetHeader(RequestTask& requestTask, const char* name, const char* value) const;
        virtual bool GetBinaryPayload(RequestTask& requestTask, void*& payload, size_t& payloadSize) const;
        virtual void ProcessResponse(RequestTask& requestTask, const int httpCode) const;
