...
namespace PlayFab
{
    ...
    protected:
        ...
        virtual void SetPredefinedHeaders(RequestTask& requestTask) const override;
        virtual bool GetBinaryPayload(RequestTask& requestTask, void*& payload, size_t& payloadSize) const override;
        virtual void ProcessResponse(RequestTask& requestTask, const int httpCode) const override;
    };
}
